...
public class BeliefStoreLoader {
    ...
    public static void loadFromFile(String filename, BeliefStore beliefStore) throws IOException {
        ...
        while ((line = reader.readLine()) != null) {
            ...
            if (line.startsWith("FACTS:")) {
                ...
                initializeVars(line.substring(5), beliefStore);
    ...
    private static void initializeVars(String initLine, BeliefStore beliefStore) {
        ...
        for (String assignment : assignments) {
            ...
            if (!assignment.isEmpty() && assignment.contains(":=")) {
                ...
                try {
                    ...
                    System.err.println("⚠️ Error parsing initial value for variable: " + assignment);
                }
            }
        }
    }
    ...
    public static void loadPNVariableUpdates(String filename, 
    		...
    		Map<String, String> placeDiscreteActions) throws IOException {
    	BufferedReader reader = new BufferedReader(new FileReader(filename));
    	String line;
    	...
    	while ((line = reader.readLine()) != null) {
    		...
    		if (inPNSection && line.contains(":")) {
    			...
    			if (matcher.find()) {
    				...
    				//actions = actions.substring(0, matcher.start()).trim(); // Extraer solo las acciones
    				...
    				if (ifIndex != -1) {
    				    ...
    				    if (closeParen > openParen) { // Asegurar que hay un `)` después de `(`
    				        ...
    				        System.err.println("⚠️ Syntax error: Unmatched parentheses in if-condition -> " + actions);
    				    }
    				}
    			...
    			if (actions.startsWith("[") && actions.endsWith("]")) {
    				...
    				if (net.getPlaces().containsKey(elementName)) {
    					...
    					System.err.println("⚠️ Warning: Element '" + elementName + "' not found in places or transitions.");
    				}
    			} else {
    				System.err.println("⚠️ Malformed line in <PN>: " + line);
    			}
    		}
    	}
    	reader.close();
